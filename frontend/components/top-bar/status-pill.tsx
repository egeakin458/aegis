...
const PHASE_LABELS: Record<OrbitPhase, string> = {
  ...
  'build-check-running': 'Verifying Code',
  'build-check-failed': 'Fixing Build Errors',
...
const PHASE_COLORS: Record<OrbitPhase, string> = {
  ...
  'build-check-running': 'bg-cyan-900/40 text-cyan-300 border border-cyan-800',
  'build-check-failed': 'bg-amber-900/40 text-amber-300 border border-amber-800',
